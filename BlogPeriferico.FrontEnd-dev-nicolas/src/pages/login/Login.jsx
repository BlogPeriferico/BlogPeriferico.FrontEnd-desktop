  ...
  return (
    <div className="flex h-screen w-full font-poppins overflow-hidden">
      ...
      <div className="relative w-1/2 bg-white z-10 flex flex-col justify-center px-16">
        ...
        <button className="w-full bg-[#2C2C2C] text-white py-3 rounded-md mb-4">
          Fazer Login
        </button>

        <button
          className="w-full bg-gray-100 border border-gray-300 text-gray-700 py-3 rounded-md mb-6"
