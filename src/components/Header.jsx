...
import {ModalVisitantes} from "./modals/ModalVisitantes.jsx"; // import default ✅
...
export default function Header() {
  ...
  // ✅ Verifica se é visitante antes de executar ação
  const verificarVisitante = (acao) => {
    const role = localStorage.getItem("userRole");
    console.log("🔍 Verificando role:", role); // debug
