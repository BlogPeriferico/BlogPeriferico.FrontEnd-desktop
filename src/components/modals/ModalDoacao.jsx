...
export default function ModalDoacao({
  ...
  const tituloId = "modal-doacao-titulo";
  const descricaoId = "modal-doacao-descricao";
  const imagemInputId = "modal-doacao-imagem";
  const tituloInputId = "modal-doacao-input-titulo";
  const descInputId = "modal-doacao-input-descricao";
  const categoriaSelectId = "modal-doacao-select-categoria";
  const zonaSelectId = "modal-doacao-select-zona";
  const telefoneInputId = "modal-doacao-input-telefone";
      ...
      >
        <div className="absolute top-4 right-4">
          <button
            ...
            aria-label="Fechar modal de anúncio de doação"
          >
        ...
        <div id={descricaoId} className="flex gap-4 items-center">
          ...
          <div className="flex-shrink-0 border border-dashed border-gray-400 rounded-lg w-[200px] h-[200px] flex flex-col items-center justify-center text-center text-gray-700 text-xs px-2 overflow-hidden">
            <label
              ...
              aria-label="Selecionar imagem para o anúncio da doação"
            >
              {imagem ? (
                <img
                  src={URL.createObjectURL(imagem)}
                  alt="Pré-visualização da imagem selecionada para o anúncio"
          ...
          <div className="flex-1 space-y-3 text-xs font-poppins">
            ...
            <div className="relative">
              <label
                htmlFor={categoriaSelectId}
                className="text-gray-700 font-semibold block"
              >
                Categoria
              </label>
              <select
                id={categoriaSelectId}
                value={categoria}
