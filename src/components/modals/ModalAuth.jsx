    ...
    >
      ...
      >
        ...
        <div
          ...
          role="tablist"
          aria-label="Seleção entre entrar ou cadastrar"
        >
          <button
            type="button"
            role="tab"
        ...
        <div className="p-6">
          ...
          <p
            id="modal-auth-description"
            className="text-sm text-gray-500 mb-4"
          >
            {activeTab === "login"
              ? "Entre para publicar conteúdos, doar, vender e aproveitar todas as funcionalidades."
              : "Cadastre-se para participar ativamente da comunidade do Blog Periférico."}
          </p>
