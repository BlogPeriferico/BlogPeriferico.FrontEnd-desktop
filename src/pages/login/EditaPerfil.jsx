...
export default function EditaPerfil() {
  ...
  const handleSaveField = async () => {
    ...
    if (
      (editingField === "email" || editingField === "senha") &&
      !tempSenhaAtual
    ) {
    ...
    try {
      ...
      if (atualizado.token) {
        localStorage.setItem("token", atualizado.token);
      }
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full relative">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  type="button"
                  onClick={closeEditModal} // ✅ agora só fecha o modal
              ...
              >
                ...
                <div className="flex gap-4 pt-6">
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex-1 bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 rounded-xl disabled:opacity-60"
                  >
